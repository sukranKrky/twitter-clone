...
export default function Post({ post }) {
  return (
    <div className="px-4 py-3  gap-3 border-b border-[color:var(--background-third)] flex relative before:absolute before:z-[-1] before:inset-0 before:hover:bg-[color:var(--background-secondary)] ">
      <img
      ...
      <div className="flex-1">
        ...
        <div className="flex -ml-1.5 mt-1.5">
            <div className="flex-1 group flex items-center gap-px ">
                ...
                <div className="w-[2.172rem]  h-[2.172rem] flex items-center rounded-full justify-center text-[color:var(--color-base-secondary)] group-hover:bg-[#1d9bf01a] group-hover:text-[#1d9bf0] ">
                ...
                <span className="text-[0.813rem]  text-[color:var(--color-base-secondary)] group-hover:text-[#1d9bf0] ">{numberFormat(post.stats.comments)} </span>
            </div>
            <div className="flex-1 group flex items-center gap-px">
							<div
