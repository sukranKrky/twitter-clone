    ...
    <div className=" w-[600px]">
      ...
      <div className="p-8 pt-0">
        ...
        <div className="mx-8 mb-4 gap-3">
          <div className="border border-[#2f3336] px-4 flex py-3 ">
            <img
...
<div className="ml-1 flex items-center text-[#71767b] ">@X · 31d</div>

              </header>
              <div className="text-[#e7e9ea] leading-5  text-[]">X'in merkezinde, tıpkı bunun gibi gönderi denen kısa mesajlar yatar. Gönderiler; fotoğraflar, videolar,
								bağlantılar, metinler, etiketler ve <Link className="text-[#1d9bf0] hover:underline"/></div>
