...
export default function More() {
  return (
    <Popover className="relative  ">
      <Popover.Button className="py-[3px] hover:bg-[color:var(--background-secondary)] block group ">
        <div
          className={classNames(
            "px-3 h-14  rounded-full  inline-flex items-center gap-5 group-hover:bg-[color:var(--background-secondary)] transition-colors"
          )}
        >
          <div className="w-[1.641rem] h-[1.641rem]  bg-transparent relative">
      ...
      <Popover.Panel className=" w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] shadow-box rounded-xl ">
        <div
          className={classNames(
            "p-3 h-14 w-full inline-flex items-center gap-5 hover:bg-[color:var(--background-third)] rounded-lg transition-colors"
          )}
        >
          ...
          <div className="pr-4 text-xl font-bold">Baglan</div>
        </div>
        <div
          className={classNames(
            "px-4 h-14 w-full inline-flex items-center gap-5 hover:bg-[color:var(--background-third)] rounded-lg transition-colors"
          )}
        >
          <div className="w-[1.641rem] h-[1.641rem] relative">
            <svg viewBox="0 0 24 24" className="h-[1.641rem]">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className=" flex items-center bg-[color:var(--background-primary)] justify-between w-full hover:bg-[color:var(--background-secondary)] overflow-hidden transition-colors  rounded-lgtransition-colors p-4 font-bold">
                İçerik Üretücüsü Stüdyosu
                <svg
                  viewBox="0 0 24 24 "
                 
                  className={classNames("transition-all h-[1.641rem]", {
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="h-[52px] flex items-center justify-between w-full hover:bg-[color:var(--background-third)] overflow-hidden  rounded-lgtransition-colors p-4 font-bold">
                Ayarlar ve Destek
                <svg
                  viewBox="0 0 24 24 "
              ...
              <Disclosure.Panel className=" text-m">
                <Link
                  to="/"
                  className="flex items-center px-3 h-11 gap-3 font-medium hover:bg-[color:var(--background-third)] transition-colors "
                >
                ...
                <button
                  ...
                  className="flex items-center px-3 h-11 gap-3 font-medium w-full hover:bg-[color:var(--background-third)] transition-colors"
                >
                  <svg viewBox="0 0 24 24" className="h-[1.172rem]">
                    <path
                      fill="currentColor"
