  ...
  return (
    <Popover className="relative">
      ...
      <Popover.Panel className=" w-[318px] absolute bottom-0 left-0 bg-black shadow-box rounded-xl ">
        <div
          className={classNames(
            "p-3 h-14 w-full inline-flex items-center gap-5 hover:bg-[#282828] rounded-lg transition-colors"
          )}
        >
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={24} height={24}>
        ...
        <div
          className={classNames(
            "px-4 h-14 w-full inline-flex items-center gap-5 hover:bg-[#282828] rounded-lg transition-colors"
          )}
        >
          <div className="w-[26.25px] h-[26.25px] relative">
            <svg viewBox="0 0 24 24" width={24} height={24}>
