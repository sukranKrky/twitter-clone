  ...
  return (
    <Popover className="relative  ">
      <Popover.Button className="py-[3px] hover:bg-[color:var(--background-secondary)] block group ">
        ...
        >
          <div className="w-[26.25px] h-[26.25px]  bg-transparent relative">
      ...
      <Popover.Panel className=" w-[318px] absolute bottom-0 left-0 bg-[color:var(--background-primary)] shadow-box rounded-xl ">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="h-[52px]  flex items-center bg-[color:var(--background-primary)] justify-between w-full hover:bg-[color:var(--background-secondary)] overflow-hidden transition-colors  rounded-lgtransition-colors px-4 font-bold">
        ...
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="h-[52px] flex items-center justify-between w-full hover:bg-[color:var(--background-third)] overflow-hidden  rounded-lgtransition-colors px-4 font-bold">
                Personel Araçları
                <svg
                  viewBox="0 0 24 24 "
                  width={18.75}
